...
function Alert(props) {
    ...
    const DisplayAlert = () => {
        if ((AlertType === "Open" && BtnType === "Confirm")) return (
            // Click Accept 
            <Dialog
                open={props.open}
                ...
                <DialogContent className={classes.alertContainer}>
                    ...
                    <DialogTitle id="form-dialog-title">Confirm your request!</DialogTitle>
                    <DialogContentText>
                        {`Complaint: ${props.title}`}
                    </DialogContentText>

                    <DialogActions className={classes.buttons}>
                        <Button fullWidth onClick={props.onClose} className={classes.confirm}>
                            Confirm
                    </Button>
                        <Button fullWidth onClick={props.onClose} className={classes.cancel}>
                            Cancel
                    </Button>
                    </DialogActions>
                </DialogContent>
        ...
        if ((AlertType === "Open" && BtnType === "Reject")) return (
            // Click Accept 
            <Dialog
                open={props.open}
                onClose={props.onClose}
